# Pocket Casts Screens — design artifacts

Importable sticker-sheet for **`Compose Material 2 + Pocket Casts theme roles`**, rendered from the committed
...
**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/pocket-casts-android/blob/design-artifacts/pocketcasts-screens/index.html)**
...
**[▶ Open the PNG↔SVG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/pocket-casts-android/blob/design-artifacts/pocketcasts-screens/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/pocketcasts-screens/)**

The same rendered components, served live by `compose-preview serve --catalogs pocketcasts-screens` —
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/pocket-casts-android/blob/design-artifacts/pocketcasts-screens/index.html) |
| `compare.html` | PNG↔SVG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/pocket-casts-android/blob/design-artifacts/pocketcasts-screens/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/pocketcasts-screens/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
