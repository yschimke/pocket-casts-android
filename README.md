...
**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/pocket-casts-android/blob/design-artifacts/pocketcasts/index.html)**
...
**[▶ Open the PNG↔SVG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/pocket-casts-android/blob/design-artifacts/pocketcasts/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/pocketcasts/)**

The same rendered components, served live by `compose-preview serve --catalogs pocketcasts` —
...
| --- | --- |
| Components | **61** |
| Rendered images (PNG) | **181** |
| Editable wireframes (SVG) | **60** |
| Editable design vectors (figma-svg) | **61** |
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/pocket-casts-android/blob/design-artifacts/pocketcasts/index.html) |
| `compare.html` | PNG↔SVG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/pocket-casts-android/blob/design-artifacts/pocketcasts/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/pocketcasts/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
